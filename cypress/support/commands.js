...
Cypress.Commands.add('fillMandatoryFieldsAndSubmit', () => {
    ...
    cy.get('#email').type('paulo@gmail.com',{delay:0})
    cy.get('#phone').type('11978542548',{delay:0})
...
Cypress.Commands.add('fillAndSearchGoogle', () => {
    cy.get('[class="gLFyf"]').type('Cypress')
    cy.get('[class="gNO89b"]').contains('Pesquisa Google').click()
